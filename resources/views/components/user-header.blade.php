        ...
        <div class="header-right">
            ...
            <div class="user-menu-container">
                <button class="profile-trigger" id="userMenuBtn">
                    @auth
                        <x-user-profile-picture :size="40" />
                    @else
                        <div style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; border-radius: 50%; background: #333;">
                            <i class="fas fa-user" style="color: #f8c300; font-size: 20px;"></i>
                        </div>
                    @endauth
                </button>
    ...
    <nav>
        <ul>
            @auth
                ...
                <li><a href="{{ route('user.request.assistance') }}" class="{{ request()->routeIs('user.request.assistance') ? 'active' : '' }}">REQUEST ASSISTANCE</a></li>
                <li><a href="{{ route('user.my.requests') }}" class="{{ request()->routeIs('user.my.requests') ? 'active' : '' }}">MY REQUESTS</a></li>
                <li><a href="{{ route('user.request.history') }}" class="{{ request()->routeIs('user.request.history') ? 'active' : '' }}">HISTORY</a></li>
            @endauth
        </ul>
    </nav>
</header>
