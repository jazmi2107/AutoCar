...
<head>
    ...
    <title>My Profile - AutoCar Admin</title>
    ...
    <div class="container">
        <div class="page-header">
            <div>
                <div class="breadcrumb">
                    <a href="{{ route('admin.dashboard') }}"><i class="fas fa-home"></i> Dashboard</a> / My Profile
                </div>
                <h1>Admin Profile</h1>
            </div>
        </div>
        ...
        <div class="profile-grid">
            ...
            <div class="profile-card">
                @php
                    $hasProfilePicture = $admin && $admin->profile_picture && \Storage::disk('public')->exists($admin->profile_picture);
            ...
            <div class="profile-content">
                ...
                <div class="content-card" id="personalInfoView">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value {{ !($admin && $admin->phone_number) ? 'empty' : '' }}">{{ $admin->phone_number ?? 'Not provided' }}</div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">
                ...
                <div class="content-card" id="personalInfoEdit" style="display: none;">
                    ...
                    <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data" class="edit-form">
                        ...
                        <div class="form-group">
                            ...
                            <div style="display: flex; align-items: center; gap: 20px;">
                                @if($hasProfilePicture)
                                    <img src="{{ asset('storage/' . $admin->profile_picture) }}" alt="Current" id="previewImage" style="width: 80px; height: 80px; border-radius: 50%; object-fit: cover; border: 3px solid #f8c300;" onerror="this.src='https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&size=80&background=f8c300&color=000&bold=true'">
                                @else
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="phone_number" name="phone_number" value="{{ old('phone_number', $admin->phone_number ?? '') }}">
                        </div>
                ...
                <div class="content-card">
                    ...
                    <form action="{{ route('admin.password.update') }}" method="POST" class="edit-form">
                        @csrf
                        @method('PUT')
